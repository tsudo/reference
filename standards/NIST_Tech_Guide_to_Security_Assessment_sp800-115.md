...
year: 2008
tags: ["nist;sp800-115;security-assessment;penetration-testing"]
source_url: "https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-115.pdf"
...
Information Security Assessment Methodology .......................................................2-1
2.1
...
(cid:31)  Develop information security assessment policy, methodology, and individual roles and

responsibilities related to the technical aspects of assessment

(cid:31)  Accurately plan for a technical information security assessment by providing guidance on
...
(cid:31)  Safely and effectively execute a technical information security assessment using the presented
methods and techniques, and respond to any incidents that may occur during the assessment

(cid:31)  Appropriately handle technical data (collection, storage, transmission, and destruction)

throughout the assessment process

(cid:31)  Conduct analysis and reporting to translate technical findings into risk mitigation actions that will
...
(cid:31)  Establish an information security assessment policy.  This identifies the organization’s
...
(cid:31)  Implement a repeatable and documented assessment methodology.  This provides
...
(cid:31)  Determine the objectives of each security assessment, and tailor the approach accordingly.
...
(cid:31)  Analyze findings, and develop risk mitigation techniques to address weaknesses.  To ensure
...
(cid:31)  Section 2 presents an overview of information security assessments, including policies, roles and

responsibilities, methodologies, and techniques.

(cid:31)  Section 3 provides a detailed description of several technical examination techniques, including

documentation review, log review, network sniffing, and file integrity checking.

(cid:31)  Section 4 describes several techniques for identifying targets and analyzing them for potential
vulnerabilities.  Examples of these techniques include network discovery and vulnerability
scanning.

(cid:31)  Section 5 explains techniques commonly used to validate the existence of vulnerabilities, such as

password cracking and penetration testing.

(cid:31)  Section 6 presents an approach and process for planning a security assessment.

(cid:31)  Section 7 discusses factors that are key to the execution of security assessments, including

coordination, the assessment itself, analysis, and data handling.

(cid:31)  Section 8 presents an approach for reporting assessment findings, and provides an overview of

remediation activities.

This guide also contains the following appendices:

(cid:31)  Appendix A describes two live operating system (OS) CD distributions that allow the user to boot

a computer to a CD containing a fully operational OS and testing tools.

(cid:31)  Appendix B provides a template for creating Rules of Engagement (ROE).

(cid:31)  Appendix C briefly discusses application security assessment.

(cid:31)  Appendix D contains recommendations for performing remote access testing.

(cid:31)  Appendix E offers a list of resources that may facilitate the security assessment process.

(cid:31)  Appendix F features a glossary of terms used throughout this document.

(cid:31)  Appendix G provides a list of acronyms and abbreviations.
...
(cid:31)  Provide consistency and structure to security testing, which can minimize testing risks

(cid:31)  Expedite the transition of new assessment staff

(cid:31)  Address resource constraints associated with security assessments.
...
(cid:31)  Planning.  Critical to a successful security assessment, the planning phase is used to gather
...
(cid:31)  Execution.  Primary goals for the execution phase are to identify vulnerabilities and validate
...
(cid:31)  Post-Execution.  The post-execution phase focuses on analyzing identified vulnerabilities to
...
(cid:31)  Review Techniques.  These are examination techniques used to evaluate systems, applications,
...
(cid:31)  Target Identification and Analysis Techniques.  These testing techniques can identify systems,
...
(cid:31)  Target Vulnerability Validation Techniques.  These testing techniques corroborate the
...
(cid:31)  Authentication server or system logs may include successful and failed authentication attempts.

(cid:31)  System logs may include system and service startup and shutdown information, installation of
...
(cid:31)  Intrusion detection and prevention system logs may include malicious activity and inappropriate

use.

(cid:31)  Firewall and router logs may include outbound connections that indicate compromised internal

devices (e.g., rootkits, bots, Trojan horses, spyware).

(cid:31)  Firewall logs may include unauthorized connection attempts and inappropriate use.

(cid:31)  Application logs may include unauthorized connection attempts, account changes, use of

privileges, and application or database usage information.

(cid:31)  Antivirus logs may include update failures and other indications of outdated signatures and

software.

(cid:31)  Security logs, in particular patch management and some IDS and intrusion prevention system
...
(cid:31)  For router access control lists
...
(cid:31)  Capturing and replaying network traffic

(cid:31)  Performing passive network discovery (e.g., identifying active devices on the network)

(cid:31)  Identifying operating systems, applications, services, and protocols, including unsecured (e.g.,

telnet) and unauthorized (e.g., peer-to-peer file sharing) protocols

(cid:31)  Identifying unauthorized and inappropriate activities, such as the unencrypted transmission of

sensitive information

(cid:31)  Collecting information, such as unencrypted usernames and passwords.
...
(cid:31)  At the perimeter, to assess traffic entering and exiting the network

(cid:31)  Behind firewalls, to assess that rulesets are accurately filtering traffic

(cid:31)  Behind IDSs/IPSs, to determine if signatures are triggering and being responded to appropriately

(cid:31)  In front of a critical system or application to assess activity

(cid:31)  On a specific network segment, to validate encrypted protocols.
...
(cid:31)  Check compliance with host application usage and security policies
...
(cid:31)  Provide information on targets for penetration testing

(cid:31)  Provide information on how to mitigate discovered vulnerabilities.
...
(cid:31)  The location of the facility being scanned, because the physical proximity of a building to a
...
(cid:31)  The security level of the data to be transmitted using wireless technologies

(cid:31)  How often wireless devices connect to and disconnect from the environment, and the typical
...
(cid:31)  Existing deployments of wireless intrusion detection and prevention systems (WIDPS16), which
...
(cid:31)  The MAC address of a discovered wireless device indicates the vendor of the device’s wireless
...
(cid:31)  If an organization has accurate records of its deployed wireless devices, assessors can compare
...
(cid:31)  Rogue devices may use SSIDs that are not authorized by the organization.

(cid:31)  Some rogue devices may use SSIDs that are authorized by the organization but do not adhere to
...
(cid:31)  How well the system tolerates real world-style attack patterns

(cid:31)  The likely level of sophistication an attacker needs to successfully compromise the system

(cid:31)  Additional countermeasures that could mitigate threats against the system

(cid:31)  Defenders’ ability to detect attacks and respond appropriately.
...
(cid:31)  Host name and IP address information can be gathered through many methods, including DNS
interrogation, InterNIC (WHOIS) queries, and network sniffing (generally only during internal
tests)

(cid:31)  Employee names and contact information can be obtained by searching the organization’s Web

servers or directory servers

(cid:31)  System information, such as names and shares can be found through methods such as
...
(cid:31)  Application and service information, such as version numbers, can be recorded through banner
...
(cid:31)  Misconfigurations.  Misconfigured security settings, particularly insecure default settings, are

usually easily exploitable.

(cid:31)  Kernel Flaws.  Kernel code is the core of an OS, and enforces the overall security model for the

system—so any security flaw in the kernel puts the entire system in danger.

(cid:31)  Buffer Overflows.  A buffer overflow occurs when programs do not adequately check input for
...
(cid:31)  Insufficient Input Validation.  Many applications fail to fully validate the input they receive
...
(cid:31)  Symbolic Links.  A symbolic link (symlink) is a file that points to another file.  Operating
...
(cid:31)  File Descriptor Attacks.  File descriptors are numbers used by the system to keep track of files
...
(cid:31)  Race Conditions.  Race conditions can occur during the time a program or process has entered
...
(cid:31)  Incorrect File and Directory Permissions.  File and directory permissions control the access
...
(cid:31)  Organizational requirements with which assessments must comply

(cid:31)  Appropriate roles and responsibilities (at a minimum, for those individuals approving and

executing assessments)

(cid:31)  Adherence to established methodology

(cid:31)  Assessment frequency

(cid:31)  Documentation requirements, such as assessment plans and assessment results.
...
(cid:31)  The size of what is being assessed, in terms of number of components (e.g., single database, all
...
(cid:31)  The complexity of what is being assessed.  More heterogeneous environments generally require

larger amounts of resources because more diverse skill sets and tools are needed.

(cid:31)  The feasibility of using a sample for assessment, along with the sample size and its makeup.  For
...
(cid:31)  The level of resources needed to conduct specific testing or examination techniques.  For
...
(cid:31)  The level of human interaction required.  For instance, if assessors are to work in tandem with IT
...
(cid:31)  The possible impact to the production systems.  For example, if a particular test technique is

likely to cause a denial of service, it should probably be used against a non-production system.

(cid:31)  The presence of sensitive personally identifiable information (PII).  If testing could expose
...
(cid:31)  How similarly the production and non-production systems can be configured.  In practice, there
...
(cid:31)  Identify technical weaknesses in a system’s security architecture and security configuration while
...
(cid:31)  Identify and validate technical weaknesses in a system’s security architecture and security
...
(cid:31)  Informing the appropriate parties—such as security officers, management, system administrators,

and users—of security assessment activities

(cid:31)  Developing assessment plans with system managers, the Information Systems Security Officer

(ISSO), and the CISO

(cid:31)  Executing examinations and tests, and collecting all relevant data

(cid:31)  Analyzing collected data and developing mitigation recommendations

(cid:31)  Conducting additional examinations and tests when needed to validate mitigation actions.
...
(cid:31)  Coordinating and communicating with the organization being assessed

(cid:31)  Ensuring that proper authority is granted, and maintaining a signed copy of the assessment plan to

ensure all updates are documented

(cid:31)  Signing and abiding by any required nondisclosure agreements

(cid:31)  Properly protecting data in accordance with the organization’s regulations, including handling,
...
(cid:31)  What is the scope of the assessment?

(cid:31)  Who is authorized to conduct the assessment?

(cid:31)  What are the assessment’s logistics?

(cid:31)  How should sensitive data be handled?

(cid:31)  What should occur in the event of an incident?
...
(cid:31)  Storage of organizational data during the assessment on the assessors’ systems, including

physical security of the systems, passwords, and data encryption

(cid:31)  Data storage upon conclusion of the assessment, to meet long-term storage requirements or

vulnerability tracking

(cid:31)  Transmission of data during or after the assessment across internal or external networks (e.g., the

Internet)

(cid:31)  Removal of data from systems upon conclusion of the assessment—in particular, for third-party
...
(cid:31)  Developing a security assessment policy.  Organizations should develop an information security
...
(cid:31)  Prioritizing and scheduling assessments.  Organizations should decide which systems should
...
(cid:31)  Selecting and customizing technical testing and examination techniques.  There are many
...
(cid:31)  Determining the logistics of the assessment.  This includes identifying all required resources,
...
(cid:31)  Developing the assessment plan.  The assessment plan documents the activities planned for an
...
(cid:31)  Addressing any legal considerations.  Organizations should evaluate potential legal concerns
...
(cid:31)  Stakeholders are aware of the assessment schedule, activities, and potential impacts the

assessment may have

(cid:31)  The assessment does not take place during upgrades, new technology integration, or other times
when the system security is being altered (e.g., testing occurs during maintenance windows or
periods of low utilization)

(cid:31)  Assessors are provided with required levels of access to the facility and systems, as appropriate

(cid:31)  Appropriate personnel such as the CIO, CISO, and ISSO are informed of any critical high-impact

vulnerabilities as soon as they are discovered

(cid:31)  Appropriate individuals are informed (e.g., assessors, incident response team, senior
...
(cid:31)  Resistance.  Resistance to assessments can come from many sources within an organization,
...
(cid:31)  Lack of Realism.  In preparing for an assessment, users and administrators sometimes modify
...
(cid:31)  Immediate Mitigation.  As security weaknesses are identified during an assessment,
...
(cid:31)  Time.  Security assessment is often incorporated into development or deployment with little
...
(cid:31)  Resources.  Security assessment faces the continual challenge of obtaining and maintaining
...
(cid:31)  Evolving Technology.  Assessors need to stay up to date on tools and testing techniques.

Budgets should allow for annual training classes and conferences where assessors can update and
refresh their skills.

(cid:31)  Operational Impact.  Although assessments are planned to prevent or limit operational impact,
...
(cid:31)  Insufficient patch management, such as failing to apply patches in a timely fashion or failing to

apply patches to all vulnerable systems

(cid:31)  Insufficient threat management, including outdated antivirus signatures, ineffective spam
filtering, and firewall rulesets that do not enforce the organization’s security policy

(cid:31)  Lack of security baselines, such as inconsistent security configuration settings on similar systems

(cid:31)  Poor integration of security into the system development life cycle, such as missing or unsatisfied

security requirements and vulnerabilities in organization-developed application code

(cid:31)  Security architecture weaknesses, such as security technologies not being properly integrated into
...
(cid:31)  Inadequate incident response procedures, such as delayed responses to penetration testing

activities

(cid:31)  Inadequate training, both for end users (e.g., failure to recognize social engineering and phishing
...
(cid:31)  Lack of security policies or policy enforcement (e.g., open ports, active services, unsecured
...
(cid:31)  Architecture and Configuration Data.  Assessment type and desired outcome will drive the
...
(cid:31)  Assessor Activities.  Assessors should keep a log that includes assessment system information
...
(cid:31)  Assessment plans and ROEs

(cid:31)  Documentation on system security configuration and network architecture

(cid:31)  Results from automated tools and other findings

(cid:31)  Assessment results report

(cid:31)  Corrective action plan or Plan of Action and Milestones (POA&M).
...
(cid:31)  Disposal: the act of discarding media with no other sanitization considerations.  This is most
often done by recycling paper that contains nonconfidential information, but may also include
other media.

(cid:31)  Clearing: a level of media sanitization that would protect information confidentiality against a
...
(cid:31)  Purging: a media sanitization process that protects information confidentiality against a
...
(cid:31)  Destruction: physical obliteration of media to render it no longer usable for its intended purpose
...
(cid:31)  As a reference point for corrective action

(cid:31)  In defining mitigation activities to address identified vulnerabilities

(cid:31)  As a benchmark for tracking an organization’s progress in meeting security requirements

(cid:31)  To assess the implementation status of system security requirements

(cid:31)  To conduct cost/benefit analysis for improvements to system security

(cid:31)  To enhance other life cycle activities, such as risk assessments, C&A, and process improvement

efforts

(cid:31)  To meet reporting requirements, such as those of FISMA.
...
(cid:31)  Discovering unauthorized remote access services.  Port scanning may be used to locate open
...
(cid:31)  Reviewing rulesets to find unintended remote access paths.  Remote access rulesets, such as
those on VPN gateways, should be reviewed for holes or misconfigurations that could permit
unwanted access.

(cid:31)  Testing remote access authentication mechanisms.  Since remote access methods normally
...
(cid:31)  Monitoring remote access communications.  Testers can monitor remote access
